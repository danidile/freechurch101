...
export default function InviteUsersModalComponent() {
  ...
  const [activeTab, setActiveTab] = useState("new-invites"); // 'new-invites' or 'sent-invites'
  ...
  return (
    <>
      <div className="flex justify-center w-full max-w-sm mx-auto relative">
        <div className="flex">
          <button
            className={`px-4 py-2 text-sm font-medium transition-colors duration-300 ${
              activeTab === "new-invites"
                ? "text-blue-600"
                : "text-gray-500 hover:text-gray-700"
            }`}
            onClick={() => setActiveTab("new-invites")}
          >
            Invia nuovi inviti
          </button>
          <button
            className={`px-4 text-center py-2 text-sm font-medium transition-colors duration-300 ${
        ...
        <div
          className={`absolute bottom-0 h-[2px] bg-blue-500 transition-all duration-300 ${
            activeTab === "new-invites" ? "left-0 w-1/2" : "left-1/2 w-1/2"
          }`}
        ></div>
      </div>
      {activeTab === "new-invites" && (
        <div className="mt-8 mx-auto p-2 max-w-[800px]">
      ...
      {activeTab === "sent-invites" && invitesSent.length >= 1 && (
        <div className="mt-8 mx-auto p-2 max-w-[800px]">
