 ...
 return (
    <div className=" hidden standalone:block">
        <ul className="container-song-list ">
            ...
            <Link className="song-list text-black" href="/protected/churchMembers" ><Image className="dashboard-icon" src="/images/dashboard/song-lyrics.png" alt="" /> Membri Chiesa</Link>
