...
import ModalRoleUpdate from "@/app/people/[peopleId]/modalRoleUpdate";
...
export default async function Page() {
  ...
  const profile: profileT = await getProfileById(userData.id);
  ...
  return (
    <div>
      ...
      <ModalRoleUpdate
        ...
        userData={userData}
      />
      <Link href="/protected/dashboard/account/completeAccount">Aggiorna profilo</Link>
