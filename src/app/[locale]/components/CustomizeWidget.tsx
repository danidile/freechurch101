...
export default function CustomizeWidget() {
  ...
  const updateFontSize = (element: string) => {
    ...
    chordsElements.forEach((el) => {
      (el as HTMLElement).style.fontSize = `${newSize}px`;
      (el as HTMLElement).style.lineHeight = `${newSize * 1.2}px`;
    });
        ...
        <DrawerContent>
          {(onClose) => (
            <>
              ...
              <DrawerBody className="flex flex-col gap-4 justify-center items-center overflow-visible">
